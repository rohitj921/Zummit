...
import Smile_Icon from "../../images/SVG_files/Smile_Icon.svg";
import therapist_card_image from "../../images/therapist_card_image.jpeg";
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        await axios
          .get(BASE_USER + `/booking/getTherapistDetails/find/${id}`)
          .then((res) => {
            if (res.data.name) {
        ...
        <div className="flex-col ml-[2vw] ">
                  ...
                  <div className="flex flex-col mt-11 max-md:mt-10">
                    ...
                    <div className="flex gap-1 pr-11 mt-3 max-md:pr-5">
                      ...
                      <img
                        ...
                        loading="lazy"
                        src={
                          "https://cdn.builder.io/api/v1/image/assets/TEMP/eed5732c7afa620313d3806b2ba64c1302afa705682c7532cb06ce25b74bc804?apiKey=8587097ed3a94b279b125430c3e068a6&"
                        }
                        className="shrink-0 w-8 aspect-square"
                      />
                    </div>
          ...
          <div className="flex flex-col justify-center px-5 py-6 text-2xl font-semibold leading-8 text-sky-800 rounded max-w-[983px] mt-[2vh] bg-[#FDFEE6] shadow-lg">
            ...
            <div className="mt-3 text-base leading-5 text-black max-md:max-w-full">
              I have always been fascinated by human behavior and why people
              become the way they are. While we all may be individually
              different, we all derive our thoughts, patterns, and behaviors in
              the same way: life experience. We also all share the ability to
              show great strength, resilience, and insight when put to the test.
              My clients inspire me and continuously motivate me to be a better
              therapist and person. It is a privilege to hold space for people
              to be vulnerable and share their stories and I am honored to play
              a small part in their journeys of self-discovery and empowerment.
            </div>
            <div className="mt-6 max-md:max-w-full">Work with me</div>
            <div className="mt-3 text-base leading-5 text-black max-md:max-w-full">
              In our busy lives, we can often suppress our thoughts and feelings
              in ways that feel convenient but can build up over time and become
              burdensome. I can help you recognize your triggers and sources of
              anxiety so you can better deal with the unique challenges that
              come your way. My identity as an Asian-American woman also informs
              my practice through my passion to help those of the 1st to 2nd
              generation immigrant families. Have you felt stuck and in-between
              worlds{" "}
            </div>
