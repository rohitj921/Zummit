    ...
    return (
      <div className="rounded-lg p-3 bg-white">
        <div className="flex gap-3">
          ...
          <div className="flex">
            <div className="w-60">
              <h1 className="font-semibold text-base leading-5 mb-2">
                {title}
              </h1>
              <p className="text-xs leading-4">{description}</p>
            </div>
            <div className="flex flex-col items-center justify-between">
              <p className="text-[0.70rem] text-nowrap shadow-md bg-[#F7F131] rounded-lg p-1">
                {notification}
              </p>
              <Link to={"/BookTherapistPage"}>
                <button className="bg-white px-6 py-1 text-[#0190B1] border-2 border-[#0190B1] rounded">
                  {buttonText}
                </button>
              </Link>
            </div>
      ...
      <div className="w-[90%] rounded-md shadow-md">
        <div className="bg-[#0190B1] text-lg flex flex-col gap-3 px-5 py-4 rounded-md rounded-b-none leading-6">
          ...
          <h3 className="font-semibold text-white">
            Appointment with <span className="text-[#F7F131]">Dr. Vaibhav</span>
          </h3>
          <p className="font-medium text-white">
            Monday: <span className="text-[#F7F131]">26-02-2024</span>
          </p>
          <p className="font-medium text-white">
            Time: <span className="text-[#F7F131]">02: 00 PM to 03: 00 PM</span>
          </p>
        ...
        <div className="bg-white flex justify-end rounded-md rounded-t-none p-4">
          <div className="w-44 flex justify-between font-medium">
            ...
            <button className="bg-white text-[#0190B1] border-2 px-4 py-1 border-[#0190B1] rounded">
              Cancel
            </button>
          </div>
        </div>
    ...
    return (
      <div className="flex bg-[#F2FCFF] gap-10">
        <div className="w-[40%] flex flex-col gap-5">
          <div>
            <h3 className="text-[#001519] text-2xl font-medium py-3">
              Hello Sanjay
            </h3>
            <p className="text-[#272529] text-xl font-semibold">
    ...
    return (
      <div>
        <div className="w-[90%] ml-5 mt-2 justify-center gap-10 items-center ">
          <div className="flex gap-10 justify-center mb-10 items-center">
            ...
            <div>
              <img onClick={handleNotification} src={BellIcon} alt="" />
            </div>
          </div>
        </div>
