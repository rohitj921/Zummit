...
import Logo from "../images/Around-With-In-logo.png";
import InstagramIcon from "../images/SVG_files/Instagram_Icon.svg"
import Twitter_Icon from "../images/SVG_files/Twitter_Icon.svg"
import WhatsappIcon from "../images/SVG_files/Whatsapp_Icon.svg"
const Footer = () => {
              ...
              <div className="privacy-popup-content scrollable-y">
                <div ref={PrintRef} className="content">
                  ...
                  <p>
                    ...
                    platform, which provides group therapies, support groups,
                  ...
                  <div className="privacy-popup-body">
                    ...
                    <li>
                      {" "}
                      We may also collect information about your interactions
                      with our platform, including your usage patterns,session
                  ...
                  <div className="privacy-popup-body">
                    ...
                    <li>
                      ...
                      access to our platform and its services, including group
                      therapies, support groups, and individual counseling
                      sessions.
                    </li>
                    <li>
                      Your information may be used to personalize your
                      experience on our platform and to communicate with you
                    ...
                    <div className="privacy-popup-body">
                      <li>
                        Your privacy and confidentiality are of utmost
                        importance to us.All interactions, communications, and
                        information shared within group therapies, support
                        groups, and individual counseling sessions are treated
                    ...
                    <div className="privacy-popup-body">
                      <li>
                        ...
                        Privacy and Confidentiality Policy, unless a longer
                    ...
                    <div className="privacy-popup-body">
                      <li>
                        Our platform is not intended for use by individuals
                        under the age of 18. We do not knowingly collect
                        personal information from children. If you believe that
                    ...
                    <div className="privacy-popup-body">
                      <li>
                        {" "}
                        We may update this Privacy and Confidentiality Policy
                        from time to time to reflect changes in our practices or
                      ...
                      <li>
                        {" "}
                        By using our online mental health platform, you consent
